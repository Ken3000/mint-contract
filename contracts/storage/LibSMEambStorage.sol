 ...
 * @dev Логику смотри в модуле SMEamb
 * @notice Библиотека хранилища амбассадорки
**/
library SMEambStorage{

    /// @dev Слот хранилища
    bytes32 constant SLOT = keccak256(bytes('SMEamb'));
    ...
    struct smeAmbStorage{
        ...
        // =============================================================
        //                            STORAGE ERC721A - префиксы '_' остались от ERC721A
        // =============================================================
    ...
    function _getStorage(bytes32 _storage) private pure returns (smeAmbStorage storage s){
        assembly{
            s.slot := _storage
        }
    }
